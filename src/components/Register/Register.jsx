...
export default function Register() {
  ...
  let yupObject = Yup.object().shape({
    ...
    rePassword: Yup.string().oneOf([Yup.ref('password')],'Rewrite your password').required('rePassword is required'),
  })
  ...
  <div className='flex items-center max-w-xl mx-auto py-10'>
    <div className='w-full p-5'>
      ...
      <form onSubmit={formik.handleSubmit} className=''>
        ...
        <div className="relative z-0 w-full mb-5 group">
            <input id="phone" onBlur={formik.handleBlur} onChange={formik.handleChange} value={formik.values.phone} type="text" name="phone" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-d-500 focus:outline-none focus:ring-0 focus:border-d-600 peer" placeholder=" " required />
        ...
        <div className="relative z-0 w-full mb-5 group">
            ...
            <label htmlFor="rePassword" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Rewrite Your Password</label>
        </div>
        ...
        <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
          ...
          <p className="text-center text-sm mt-2">Already have an account? <span className="text-green-600 hover:text-green-800"><Link to={'/login'}>Login in</Link></span></p>
      </form>
    </div>
  </div>
